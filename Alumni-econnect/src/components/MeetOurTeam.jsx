...
// import Loop from "../assets/loop.png"; // Import the image
    ...
    <div className="bg-gray-100 mt-0 relative">
      <div className="container mx-auto px-6 text-center">
        <div className="mb-4 relative">
          <h2 className="text-2xl md:text-4xl font-bold text-[#2d545e] mb-6 mt-4 flex items-center justify-center">
            Meet Our Teams
              ...
              {teamMembers.map((member, index) => (
                ...
                >
                  <div className="bg-white p-4 rounded-lg shadow-md flex flex-col items-center h-80">
                    ...
                    />
                    <h3 className="text-lg text-[#2d545e] font-semibold">{member.name}</h3>
                    <p className="text-sm text-gray-400">{member.role}</p>
                    {/* Set fixed height for description */}
                    <p className="text-sm text-gray-400 mt-2 h-16 flex-grow">
                      {member.description}
                    </p>
